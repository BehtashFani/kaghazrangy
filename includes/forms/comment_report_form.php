...
<div class="comment_report_text"><?php echo COMMENT_REPORT_TITLE; ?></div><br />
...
<form action="" method="get" onsubmit="return false;">
    ...
    <br />
      ...
      <input type="submit" name="Submit" id="report_submit" value="<?php echo WALLPAPER_SUBMIT_REPORT;?>" onclick="SendReport(<?php echo $id.",'".$setting['site_url'];?>', <?php echo $type;?>)" />
